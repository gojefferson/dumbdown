define(["exports"], function (_exports) {
  ...
  function (_Node) {
    ...
    _createClass(ParentNode, [{
      key: "getPlain",
      value: function getPlain() {
        var childContents = this.children.reduce(function (accum, child) {
          return accum + child.getPlain();
        }, "");

        if (this.blockElement) {
          return "".concat(childContents.trim(), " ");
        }
      ...
      value: function getHtml() {
        ...
        if (this.parentTag) {
          return "<".concat(this.parentTag, ">").concat(childContents.trim(), "</").concat(this.parentTag, ">");
        } else {
          return childContents.trim();
        }
      }
    ...
    _createClass(Parser, [{
      ...
      value: function _buildTree() {
        ...
        this._lines.forEach(function (line) {
          ...
          _this5._tree.root.appendChild(p);
        });
      }
    }, {
      key: "toHtml",
